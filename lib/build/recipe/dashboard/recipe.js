...
const userInfoGet_1 = require("./api/userinfo/userInfoGet");
const emailverification_1 = require("./api/userinfo/emailverification");
const session_1 = require("./api/userinfo/session");
const userMetaDataGet_1 = require("./api/userinfo/userMetaDataGet");
    ...
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.handleAPIRequest = (id, req, res, __, ___) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                } else if (id === constants_1.USER_INFO_API) {
                    apiFunction = userInfoGet_1.default;
                } else if (id === constants_1.EMAIL_VERIFY_API) {
                    apiFunction = emailverification_1.isEmailVerifiedAPI;
                } else if (id === constants_1.USER_SESSIONS_API) {
                    apiFunction = session_1.userSessionsGet;
                } else if (id === constants_1.USER_METADATA_API) {
                    apiFunction = userMetaDataGet_1.default;
                }
