...
function getApiIdIfMatched(path, method) {
    ...
    if (path.getAsStringDangerous().endsWith(constants_1.USER_INFO_API) && method === "get") {
        return constants_1.USER_INFO_API;
    }
    if (path.getAsStringDangerous().endsWith(constants_1.EMAIL_VERIFY_API) && method === "get") {
        return constants_1.EMAIL_VERIFY_API;
    }
